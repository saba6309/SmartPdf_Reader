...
def user_input(user_question, model_name, api_key, pdf_docs, conversation_history):
    ...
    st.markdown(
        ...
        <div class="chat-message user">
            <div class="avatar">
                <img src="https://www.vecteezy.com/png/19879186-user-icon-on-transparent-background">
            </div>    
            <div class="message">{user_question_output}</div>
        </div>
        <div class="chat-message bot">
            <div class="avatar">
                <img src="https://imgs.search.brave.com/wNdFZjzlB8RsoTocppB-aGCtxOaJFNCfGHIN3aU3C5w/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9yZWdp/c3RyeS5ucG1taXJy/b3IuY29tL0Bsb2Jl/aHViL2ljb25zLXN0/YXRpYy1wbmcvbGF0/ZXN0L2ZpbGVzL2Rh/cmsvbGFuZ2NoYWlu/LWNvbG9yLnBuZw" >
            </div>
    ...
    for question, answer, model_name, timestamp, pdf_name in reversed(conversation_history):
        st.markdown(
            ...
            <div class="chat-message user">
                <div class="avatar">
                    <img src="https://www.vecteezy.com/free-png/user">
                </div>    
    ...
    #st.snow()
def main():
    st.set_page_config(page_title="SmartPDF Reader", page_icon=":books:")
    st.header("SmartPDF Reader :books:")

    if 'conversation_history' not in st.session_state:
        st.session_state.conversation_history = []
    kaggle_profile_link = "https://www.kaggle.com/shafiasaba"
    github_profile_link = "https://github.com/saba6309"
